...
export const TEXTS = {
  de: {
    ...
    stats: {
      ...
      finalExamOverview: "Gesamtübersicht mit Abschlussprüfungen",
      avgWithoutFinalExams: "Ohne Abschlussprüfungen",
      avgWithFinalExams: "Mit Abschlussprüfungen",
      noFinalExamYet: "Noch keine Note",
      subjectOverall: "Fach-Gesamtdurchschnitt"
    },
    auth: {
      login: "Anmelden",
      signup: "Registrieren",
    ...
    settingsView: {
      ...
      betaFeaturesDesc: "Aktiviere experimentelle Funktionen wie KI-gestützten Noten-Import.",
    ...
    templateDisclaimer: "⚠️ Hinweis: Nicht alle Berechnungen sind garantiert korrekt. Bitte überprüfe die Ergebnisse.",
    aiConsent: {
      title: "Datenschutz-Hinweis",
      message: "Die KI-Funktion sendet dein Bild und deine Notendaten an externe Dienste (Google). Bist du damit einverstanden?",
  ...
  en: {
    ...
    stats: {
      ...
      finalExamOverview: "Overall with Final Exams",
      avgWithoutFinalExams: "Without Final Exams",
      avgWithFinalExams: "With Final Exams",
      noFinalExamYet: "No grade yet",
      subjectOverall: "Subject Overall Average"
    },
    auth: {
      login: "Login",
      signup: "Sign Up",
    ...
    settingsView: {
      ...
      betaFeaturesDesc: "Enable experimental features like AI-powered grade import.",
    ...
    templateDisclaimer: "⚠️ Notice: Not all calculations are guaranteed to be correct. Please verify the results.",
    aiConsent: {
      title: "Privacy Notice",
      message: "The AI function sends your image and grade data to external services (Google). Do you agree?",
  ...
  fr: {
    ...
    stats: {
      ...
      finalExamOverview: "Aperçu avec examens finaux",
      avgWithoutFinalExams: "Sans examens finaux",
      avgWithFinalExams: "Avec examens finaux",
      noFinalExamYet: "Pas encore de note",
      subjectOverall: "Moyenne globale par matière"
    },
    auth: {
      login: "Connexion",
      signup: "S'inscrire",
    ...
    settingsView: {
      ...
      betaFeaturesDesc: "Activer les fonctionnalités expérimentales comme l'import de notes par IA.",
    ...
    templateDisclaimer: "⚠️ Remarque : Tous les calculs ne sont pas garantis corrects. Veuillez vérifier les résultats.",
    aiConsent: {
      title: "Avis de confidentialité",
      message: "La fonction IA envoie votre image et vos données de notes à des services externes (Google). Êtes-vous d'accord ?",
...
export const TEMPLATES: SchoolConfig[] = [
  // 1. BM 2 Technik, Architektur, Life Sciences (TALS) - Vollzeit
  {
    ...
    disclaimer: "⚠️ Hinweis: Nicht alle Berechnungen sind garantiert korrekt. Bitte überprüfe die Ergebnisse.",
    semesters: [
  ...
  // 4. BM 2 Technik, Architektur, Life Sciences (TALS) - Teilzeit (2 Jahre)
  {
    ...
    subjects: [
      ...
      },
      {
        id: "nw", name: "Naturwissenschaften", weight: 1, rounding: "0.5",
        hasFinalExam: true, finalExamWeight: 50,
        subCategoryMode: "perSemester",
        semesters: [1, 2, 3, 4], grades: [], commingGrades: [], subCategories: [
          {
            name: "Physik",
            weight: 50,
            semesterWeights: { 1: 50, 2: 50, 3: 100, 4: 100 },
            rounding: "0.5",
      ...
      },
      {
        id: "idpa", name: "IDPA", weight: 1, rounding: "0.5",
        hasFinalExam: false,
        subCategoryMode: "global",
        semesters: [2, 3], grades: [], commingGrades: [], subCategories: [
          {
            name: "IDAF 1",
            weight: 25,
            rounding: "0.5",
            semesters: [2], grades: [], commingGrades: []
          },
          {
            name: "IDAF 2",
            weight: 25,
            rounding: "0.5",
            semesters: [3], grades: [], commingGrades: []
          },
          {
            name: "IDPA",
            weight: 50,
